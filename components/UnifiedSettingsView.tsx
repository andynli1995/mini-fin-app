...
// Finance-specific settings component
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {isSaving ? 'Saving...' : 'Save Finance Settings'}
      </button>
    </div>
  )
}
...
export default function UnifiedSettingsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-lg p-4 sm:p-6 border border-gray-200 dark:border-slate-700">
        ...
        {hasPin && (
          <>
            <div className="mb-6 pb-6 border-b border-gray-200 dark:border-slate-700">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                    How long to keep the app unlocked after entering PIN (in minutes)
                  </p>
                  <select
            ...
            {/* PIN Update */}
            <div className="mb-6">
              <h3 className="text-md font-semibold text-gray-900 dark:text-gray-100 mb-4">Update PIN Code</h3>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-lg p-4 sm:p-6 border border-gray-200 dark:border-slate-700">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Tool Settings</h2>
        <div className="space-y-4">
          {/* Finance Manager Settings */}
          <div className="border border-gray-200 dark:border-slate-700 rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                <Wallet className="w-5 h-5 mr-2 text-blue-600 dark:text-blue-400" />
